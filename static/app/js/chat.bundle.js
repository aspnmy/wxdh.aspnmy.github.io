        ...
        A.exports = {
            ...
            run: function (e) {
                new Vue({
                     ...
                     */
                    mounted: function () {
                        /** GIF 录制与视频录制初始化已迁移至 media.js */
                        window.MediaManager.initRecording();
                    },
                    function() {
                    ...
                    methods: Object.assign({
                        /**
                         * 保存为 PNG 图片：委托给 MediaManager 处理
                         */
                        save: function () {
                            window.MediaManager.saveSnapshot(this);
                        },
                        /**
                         * Canvas 转图片 DataURL：委托给 MediaManager 处理
                         * @param {HTMLCanvasElement} A - Canvas 元素
                         * @returns {string} PNG 格式的 data URL
                         */
                        canvas2image: function (A) {
                            return window.MediaManager.canvas2image(A);
                        },
                        /**
...
/**
                         * 应用或移除水印：委托给 MediaManager 处理
                         */
                        __: function () {
                            window.MediaManager.applyWatermark(this);
                        },
                        /**
                         * 定时刷新水印：委托给 MediaManager 处理
                         */
                        ___: function () {
                            window.MediaManager.refreshWatermark(this);
                        }
                    }, e.methods),
                    watch: Object.assign({
                        phone: {
